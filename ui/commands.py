...
from ui.general import next_button,back_button, WINDOW_TITLE, error_empty, EVENT_NEXT_BUTTON, EVENT_BACK_BUTTON
...
def runView(bot:Bot, plugins: list[Plugin]) -> bool:
